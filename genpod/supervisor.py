...
class SupervisorMember(AgentMember[SupervisorState, SupervisorWorkflow]):
    ...
    def __init__(self, agents: ProjectAgents, graphs: ProjectGraphs, persistance_db_path: str) -> None:
        """
        ...
        super().__init__(
            ...
            SupervisorState, 
            SupervisorWorkflow(
                supervisor_graph.graph_id, 
                supervisor_graph.graph_name,
                supervisor_config.agent_id,
                supervisor_config.agent_name,
                supervisor_config.llm, 
                persistance_db_path)
        )
