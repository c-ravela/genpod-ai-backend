...
class CoderState(TypedDict):
    ...
    project_name: Annotated[
        str, 
        State.in_field("The name of the project.")
    ]
    ...
    requirements_document: Annotated[
        str, 
        State.in_field("A comprehensive, well-structured document in markdown format that outlines "
    ...
    current_task: Annotated[
        Task,
        State.inout_field("The Task object currently in focus, representing the active task that team "
    ...
    messages: Annotated[
        list[tuple[str, str]], 
        State.inout_field("A chronological list of tuples representing the conversation history between the "
