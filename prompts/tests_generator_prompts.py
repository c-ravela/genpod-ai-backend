...
class TestGeneratorPrompts:
    ...
    test_generation_prompt: PromptWithConfig = PromptWithConfig(
    ...
    skeleton_generation_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
    ...
    skeleton_generation_for_issue_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
    ...
    unit_test_generation_for_issue_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
