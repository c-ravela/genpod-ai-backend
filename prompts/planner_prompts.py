...
class PlannerPrompts:
    task_breakdown_prompt: PromptWithConfig = PromptWithConfig(
    ...
    detailed_requirements_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
    ...
    segregation_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
            Objective:
    ...
    issues_segregation_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
