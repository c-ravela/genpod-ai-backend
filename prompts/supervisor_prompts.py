...
class SupervisorPrompts:
    delegator_prompt: PromptWithConfig = PromptWithConfig(
    ...
    response_evaluator_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
    ...
    architect_call_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
    ...
    additional_info_req_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
    ...
    init_rag_questionaire_prompt: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
    ...
    follow_up_questions: PromptWithConfig = PromptWithConfig(
        template=PromptTemplate(
            template="""
    ...
    ideal_init_rag_questionaire_prompt: PromptWithConfig = PromptWithConfig(
        PromptTemplate(
